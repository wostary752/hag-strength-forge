...
const featuredProducts = [
  ...
  { id: "lat-pulldown", title: "Тяга верхнего блока HGL294", image: latPulldownMain, description: "Грузоблочный тренажёр для тренировки широчайших мышц спины.", price: "185 000 ₽", href: "/product/lat-pulldown", imagePosition: "center 70%" },
