...
const featuredProducts = [
  ...
  { id: "lat-pulldown", title: "Тяга верхнего блока HGL294", image: latPulldownMain, description: "Грузоблочный тренажёр для тренировки широчайших мышц спины.", price: "185 000 ₽", href: "/product/lat-pulldown", imagePosition: "center 70%" }, title: "Тяга верхнего блока HGL294", image: latPulldownMain, description: "Грузоблочный тренажёр для тренировки широчайших мышц спины.", price: "185 000 ₽", href: "/product/lat-pulldown", imagePosition: "center 70%" }, },
  ...
  { id: "bench-universal", title: "Скамья HGL03", image: bench45, description: "Регулируемая скамья для жима. Угол до 90°.", price: "35 000 ₽", href: "/product/bench-universal", imageFit: "contain" as const },
];
